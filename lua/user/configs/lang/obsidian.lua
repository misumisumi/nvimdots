...
_G.my_custom_completion = function(arglead, cmdline, cursorpos)
	...
	for index, value in ipairs(templates_dir) do
		print(index, value)
	end
	...
	obsidian.setup({
		...
		ui = {
			...
			checkboxes = {
				...
				["x"] = { char = icons.ui.Accepted, hl_group = "ObsidianDone" },
				[">"] = { char = icons.ui.ChevronRight, hl_group = "ObsidianRightArrow" },
				["~"] = { char = icons.ui.Indicator, hl_group = "ObsidianTilde" },
			},
			-- Use bullet marks for non-checkbox lists.
			bullets = { char = "•", hl_group = "ObsidianBullet" },
			external_link_icon = { char = icons.ui.Symlink, hl_group = "ObsidianExtLinkIcon" },
